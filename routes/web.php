...
Route::get('/order/confirm', [AppController::class, 'confirm_order_page'])->middleware('auth');
Route::post('/order/submit', [AppController::class, 'submit_order'])->middleware('auth');
Route::get('/order/{order_id}', [AppController::class, 'order_status'])->middleware('auth')->name('order_status');
